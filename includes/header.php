...
$menus = [
    'admin' => [
        ...
        ['type'=>'item','key'=>'activities',          'label'=>'กิจกรรม',            'icon'=>'bi-calendar-event',   'url'=>null],
        ['type'=>'item','key'=>'documents',           'label'=>'เอกสาร',             'icon'=>'bi-folder2-open',     'url'=>null],
        ['type'=>'item','key'=>'certificates',        'label'=>'เกียรติบัตร',         'icon'=>'bi-award',            'url'=>null],
        ['type'=>'item','key'=>'calendar',            'label'=>'ปฏิทิน',             'icon'=>'bi-calendar3',        'url'=>null],
        ['type'=>'item','key'=>'reports',             'label'=>'รายงานสรุป',         'icon'=>'bi-graph-up',         'url'=>null],
        ...
        ['type'=>'item','key'=>'notification_settings','label'=>'ตั้งค่าการแจ้งเตือน','icon'=>'bi-bell-fill',        'url'=>null],
    ],
    'director' => [
    ...
    'employee' => [
        ...
        ['type'=>'item','key'=>'my_activities',       'label'=>'กิจกรรมของฉัน',      'icon'=>'bi-person-check',     'url'=>null],
        ['type'=>'item','key'=>'personal_activities', 'label'=>'กิจกรรมส่วนตัว',     'icon'=>'bi-journal-bookmark', 'url'=>null],
        ['type'=>'item','key'=>'available',           'label'=>'กิจกรรมที่เปิดรับ',  'icon'=>'bi-megaphone',        'url'=>null],
        ['type'=>'item','key'=>'my_certificates',     'label'=>'เกียรติบัตรของฉัน',  'icon'=>'bi-award',            'url'=>null],
        ['type'=>'item','key'=>'my_calendar',         'label'=>'ปฏิทินของฉัน',       'icon'=>'bi-calendar3',        'url'=>null],
        ['type'=>'item','key'=>'my_reports',          'label'=>'รายงานของฉัน',       'icon'=>'bi-graph-up',         'url'=>null],
    ],
];
$menu = $menus[$role] ?? [];
